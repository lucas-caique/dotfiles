...
alias quartus='(cd ~/altera/13.0sp1/quartus/bin/; ./quartus --64bit &)'
alias prps='cd ~/programming/python/streetview/'
...
source /home/lucas/repos/zsh-syntax-highlighting/zsh-syntax-highlighting.zsh
